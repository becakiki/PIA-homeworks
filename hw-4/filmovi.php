...
<div class="movie-items  full-width">
	<div class="row">
		<div class="col-md-12">
			...
			<div class="container">
			  <form  method="post" action="filmoviPretraga.php">
				<h5 class="boja">Pretraga po nazivu filma</h5><br/>
				<input type="text" name="naslov" style="width:30%;" placeholder="Unesite naziv filma..."><br/>
				<button type="submit" name="btnPretrazi" class="btn btn-primary">Pretrazi</button>
			  </form>
			  <br/><br/>
			  <form  method="post" action="filmoviPretragaZanr.php">
				<h5 class="boja">Pretraga po žanru</h5><br/>
				<input type="text" name="zanr" style="width:30%;" placeholder="Unesite žanr..."><br/>
				<button type="submit" name="btnPretraziZanr" class="btn btn-primary">Pretrazi</button>
			  </form>
			</div>
		</div>
	</div>  
